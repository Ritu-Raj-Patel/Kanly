          ...
          <div className="flex gap-3 pt-2">
            {mode === 'edit' && onDelete && (
              <button
                ...
                disabled={loading}
                className="px-4 py-2.5 rounded-xl text-red-600 hover:bg-red-50 font-medium text-sm transition-colors disabled:opacity-50"
              >
                Delete
              </button>
            )}
            ...
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="px-4 py-2.5 glass-button rounded-xl text-gray-700 font-medium text-sm disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 glass-button-dark rounded-xl text-white font-medium text-sm disabled:opacity-50"
            >
